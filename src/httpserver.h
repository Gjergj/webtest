...
class http_sync_server : public QObject
{
    ...
    Q_OBJECT
public:
    explicit http_sync_server(boost::asio::io_service &io_service, QObject *parent = 0);
    ~http_sync_server();
...
private:
    ...
    void on_accept(session *new_session, error_code ec);
